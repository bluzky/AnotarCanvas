...
/// A freehand highlight stroke — same geometry as PencilObject but rendered
/// with fixed width and semi-transparent opacity.
@MainActor
public struct HighlightObject: CanvasObject, StrokableObject, CopyableCanvasObject, @preconcurrency Codable {
    ...
    public var strokeColor: Color = .yellow
    public var strokeWidth: CGFloat = HighlightTool.strokeWidth
    ...
    public init(
        ...
        self.strokeWidth = HighlightTool.strokeWidth
    ...
    public init(from decoder: Decoder) throws {
        ...
        strokeWidth = HighlightTool.strokeWidth
        strokeStyle = .solid
    }
    ...
    public func copied(newId: UUID, zIndex: Int, offset: CGPoint) -> HighlightObject {
...
private extension HighlightObject {
...
extension HighlightObject {
    ...
    public func localSmoothPath() -> Path {
        ...
        return HighlightObject.buildSmoothPath(from: offsetPoints)
    }

    public func smoothPath() -> Path {
        return HighlightObject.buildSmoothPath(from: points)
    }
