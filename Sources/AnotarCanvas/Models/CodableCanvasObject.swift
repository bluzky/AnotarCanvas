...
@MainActor
public enum CodableObjectRegistry {
    ...
    public static func register<T: CopyableCanvasObject>(_ type: T.Type, discriminator: String) {
    ...
    public static func discriminator(for object: AnyCanvasObject) -> String? {
        discriminators[object.underlyingTypeId]
    }

    /// Encode an AnyCanvasObject to Data using its registered encoder.
    public static func encode(_ object: AnyCanvasObject) -> Data? {
    ...
    public static func decode(discriminator: String, data: Data) -> (any CopyableCanvasObject)? {
...
public struct CodableCanvasObject: Codable {
    public let typeDiscriminator: String
